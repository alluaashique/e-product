            ...
            <div class="row w3-services-grids">
                <div class="col-lg-4 col-md-6 causes-grid">
                    <div class="causes-grid-info">
                        ...
                        <a href="blog-single.html"><img src="{{ asset('user_assets/images/blog1.jpg') }}" class="img-fuild radius-image-full"
                                alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 causes-grid">
                    <div class="causes-grid-info">
                        ...
                        <a href="blog-single.html"><img src="{{ asset('user_assets/images/blog2.jpg') }}" class="img-fuild radius-image-full"
                                alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 causes-grid">
                    <div class="causes-grid-info">
                        ...
                        <a href="blog-single.html"><img src="{{ asset('user_assets/images/blog3.jpg') }}" class="img-fuild radius-image-full"
                                alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 causes-grid">
                    <div class="causes-grid-info">
                        ...
                        <a href="blog-single.html"><img src="{{ asset('user_assets/images/blog4.jpg') }}" class="img-fuild radius-image-full"
                                alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 causes-grid">
                    <div class="causes-grid-info">
                        ...
                        <a href="blog-single.html"><img src="{{ asset('user_assets/images/blog5.jpg') }}" class="img-fuild radius-image-full"
                                alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 causes-grid">
                    <div class="causes-grid-info">
                        ...
                        <a href="blog-single.html"><img src="{{ asset('user_assets/images/blog6.jpg') }}" class="img-fuild radius-image-full"
                                alt=""></a>
                    </div>
                </div>
            </div>
                ...
                <div class="cwp4-two">
                    <div class="cwp4-text">
                        ...
                        <ul class="cont-4 mt-4">
                            ...
                            <li><span class="fa fa-check"></span>More than half (56%) of the under 5 deaths occur within
                                the
                    ...
                    <div class="cwp4-text mt-md-5 mt-4">
                        ...
                        <ul class="cont-4 mt-4">
                            ...
                            <li><span class="fa fa-check"></span> While Save the Children appreciates monthly donations
                                more
